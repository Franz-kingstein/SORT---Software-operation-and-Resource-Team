# Unit Tests for Inventory Project
...
class TestInventoryUnits(unittest.TestCase):
    """Comprehensive unit tests for inventory components."""
...
if __name__ == '__main__':
    # Run with coverage: python -m pytest --cov=inventory test_inventory_unit.py
    unittest.main()
