# Unit Tests for User_Mgmt Project
...
class TestUser_MgmtUnits(unittest.TestCase):
    """Comprehensive unit tests for user_mgmt components."""
...
if __name__ == '__main__':
    # Run with coverage: python -m pytest --cov=user_mgmt test_user_mgmt_unit.py
    unittest.main()
